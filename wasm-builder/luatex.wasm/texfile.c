...
#define bufsize buf_size      // Alias correction if required
#define maxbufstack max_buf_stack  // Same as above if typo was consistent

// extern int psk_input_line;
// extern boolean psk_input_line(FILE *f);  // Declaration only

char *nameoffile;
unsigned namelength;
int texinputtype = 0;
int tfmtemp = 0;              // Stub or adjust based on expected logic

int kpse_absolute_p(const char *, int);
